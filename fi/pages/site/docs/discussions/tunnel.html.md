 Tunnel
Discussion Tammikuu 2016 0.9.41 Note:
...
This technique could later be used deliver message mid stream, or to
...
Welterde has proposed modifications to the parallel method to allow for
