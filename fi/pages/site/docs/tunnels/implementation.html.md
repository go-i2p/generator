 Tunnel
Implementation Tammikuu 2016 0.9.41 This page documents the current tunnel implementation.
...
+-----------------+-----------------+-----------------+-----------------+
| Rooli | Preprocessing | Encryption | Postprocessing |
| | | Operation | |
+=================+=================+=================+=================+
...
| ------------- | | | |
+-----------------+-----------------+-----------------+-----------------+
| Inbound Gateway | Fragment, | Encrypt | Forward to next |
| | Batch, and Pad | | hop |
+-----------------+-----------------+-----------------+-----------------+
| Participant |   | Encrypt | Forward to next |
| | | | hop |
+-----------------+-----------------+-----------------+-----------------+
