...
+-----------------+-----------------+-----------------+-----------------+
| Szerep | Preprocessing | Encryption | Postprocessing |
| | | Operation | |
+=================+=================+=================+=================+
...
| | | operations) | |
+-----------------+-----------------+-----------------+-----------------+
| Résztvevő |   | Decrypt (using | Forward to next |
| | | an encryption | hop |
| | | operation) | |
+-----------------+-----------------+-----------------+-----------------+
| Kimenő Végpont |   | Decrypt (using | Reassemble |
...
| ------------- | | | |
+-----------------+-----------------+-----------------+-----------------+
| Bejövő Átjáró | Fragment, | Titkosítás | Forward to next |
| (Gateway) | Batch, and Pad | | hop |
+-----------------+-----------------+-----------------+-----------------+
| Résztvevő |   | Titkosítás | Forward to next |
| | | | hop |
+-----------------+-----------------+-----------------+-----------------+
