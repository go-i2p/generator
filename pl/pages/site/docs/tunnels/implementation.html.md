...
+-----------------+-----------------+-----------------+-----------------+
| Rola | Preprocessing | Encryption | Postprocessing |
| | | Operation | |
+=================+=================+=================+=================+
...
| | | operations) | |
+-----------------+-----------------+-----------------+-----------------+
| Uczestnik |   | Decrypt (using | Forward to next |
| | | an encryption | hop |
| | | operation) | |
+-----------------+-----------------+-----------------+-----------------+
| Wyjściowy punkt |   | Decrypt (using | Reassemble |
| końcowy | | an encryption | Fragments, |
...
| ------------- | | | |
+-----------------+-----------------+-----------------+-----------------+
| Brama wejściowa | Fragment, | Szyfruj | Forward to next |
| | Batch, and Pad | | hop |
+-----------------+-----------------+-----------------+-----------------+
| Uczestnik |   | Szyfruj | Forward to next |
| | | | hop |
+-----------------+-----------------+-----------------+-----------------+
