...
### Tunele serwerów {#default-server-tunnels}
...
### Tunele klienta {#default-client-tunnels}
...
### Standardowy {#client-modes-standard}
...
### Standardowy {#server-mode-standard}
