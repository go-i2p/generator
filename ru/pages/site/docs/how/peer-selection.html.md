...
Профили используются в двух целях:
...
### Последовательность узлов в туннелях
...
- [Выбор и профилирование узла в Анонимной Сети
 I2P](pdf/I2P-PET-CON-2009.1.pdf)
- [Одной ячейки
 достаточно](http://blog.torproject.org/blog/one-cell-enough)
- [Входные стражи
