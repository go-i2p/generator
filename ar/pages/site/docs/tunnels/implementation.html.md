...
+-----------------+-----------------+-----------------+-----------------+
| دور | Preprocessing | Encryption | Postprocessing |
| | | Operation | |
+=================+=================+=================+=================+
...
| | | operations) | |
+-----------------+-----------------+-----------------+-----------------+
| المشارك |   | Decrypt (using | Forward to next |
| | | an encryption | hop |
| | | operation) | |
+-----------------+-----------------+-----------------+-----------------+
| نقطة الخروج |   | Decrypt (using | Reassemble |
...
| ------------- | | | |
+-----------------+-----------------+-----------------+-----------------+
| نقطة الدخول | Fragment, | للتشفير | Forward to next |
| | Batch, and Pad | | hop |
+-----------------+-----------------+-----------------+-----------------+
| المشارك |   | للتشفير | Forward to next |
| | | | hop |
+-----------------+-----------------+-----------------+-----------------+
