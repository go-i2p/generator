 Tunnel
Implementation Iulie 2019 0.9.41 This page documents the current tunnel implementation.
...
| | | operation) | |
+-----------------+-----------------+-----------------+-----------------+
| Sfarșitul |   | Decrypt (using | Reassemble |
| ieșirii | | an encryption | Fragments, |
...
| ------------- | | | |
+-----------------+-----------------+-----------------+-----------------+
| Gateway intrare | Fragment, | Criptează | Forward to next |
| | Batch, and Pad | | hop |
+-----------------+-----------------+-----------------+-----------------+
| Participant |   | Criptează | Forward to next |
| | | | hop |
+-----------------+-----------------+-----------------+-----------------+
