...
majuscule și nu s-au conformat standardelor de versiune I2P. Se
recomandă ca versiunile ulterioare să folosească doar cifrele 0-9.
00.00.10
...
ASCII test puke forth.
 ...
 EXEMPLU DIALOG SESIUNE - telnet simplu
127.0.0.1 2827  lucreaza A = Application C = Răspunsul comenzii BOB.
FROM TO DIALOGUE C A BOB 00.00.10 C A OK A C setnick mouth C A OK
Nickname set to mouth A C newkeys C A OK
...
Acum pentru cealaltă jumătate, pentru a putea contacta această
destinație.
...
atunci când tastați prea repede, și vă arată cum arată mesajele EROARE
tipice.
...
și este comutat cu comanda „liniștită".
