...
I2P 提供了一个通用的命名库和一个基本实现
用于从本地名称到目的地的映射，以及一个称为
[地址簿](#addressbook)的附加应用程序. I2P也支持 [Base32
主机地址](#base32) 就像Tor的.onion地质。
...
命名系统相当简单，大部分是在路由器外的应用程序中实现的。 但与 I2P
发行版捆绑在一起。 这些组件是：
