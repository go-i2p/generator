 Tunnel
Implementation Luglio 2019 0.9.41 This page documents the current tunnel implementation.
...
+-----------------+-----------------+-----------------+-----------------+
| Ruolo | Preprocessing | Encryption | Postprocessing |
| | | Operation | |
+=================+=================+=================+=================+
...
| | | operations) | |
+-----------------+-----------------+-----------------+-----------------+
| Partecipante |   | Decrypt (using | Forward to next |
| | | an encryption | hop |
| | | operation) | |
+-----------------+-----------------+-----------------+-----------------+
| Punto Finale in |   | Decrypt (using | Reassemble |
| Uscita | | an encryption | Fragments, |
...
| ------------- | | | |
+-----------------+-----------------+-----------------+-----------------+
| Gateway in | Fragment, | Cripta | Forward to next |
| entrata | Batch, and Pad | | hop |
+-----------------+-----------------+-----------------+-----------------+
| Partecipante |   | Cripta | Forward to next |
| | | | hop |
+-----------------+-----------------+-----------------+-----------------+
