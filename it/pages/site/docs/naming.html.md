...
- Must contain only \[a-z\] \[0-9\] \'.\' and \'-\' after conversion
 to lower case.
- Non deve iniziare con un \'.\' o un \'-\'.
- Deve finire con \'.i2p\'.
- 67 caratteri massimo, \'.i2p\' incluso.
- Non deve contenere \'..\'.
- Non deve contenere un \'.-\' o un \'-.\' (dalla v.0.6.1.33).
- Non deve contenere \'\--\' tranne nello \'xn\--\' per IDN.
...
- Lunghezza minima della chiave: 516 byte.
- Lunghezza massima della chiave: 616 byte (tenendo conto di
 certificati fino a 100 byte).
