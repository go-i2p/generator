...
- [Introduzione](#intro)
- [I2P Operation](#op)
 - [Panoramica](#op.overview)
 - [Tunnel](#op.tunnels)
 - [Database della Rete](#op.netdb)
 - [Transport protocols](#op.transport)
 - [Crittografia](#op.crypto)
- [Futuro](#future)
...
*[sito web](http://www.freenetproject.org/)*
...
## Libreria di streaming {#app.streaming}
