 Incorporare I2P
nella vostra Applicazione 2023-01 2.1.0 

## Panoramica

Questa pagina tratta dell\'inclusione dell\'intero router I2P, in
binario, assieme alla vostra applicazione. Non riguarda la realizzazione
di un applicazione che interagisca con I2P (sia essa abbinata a I2P o
esterna). However, many of the guidelines may be useful even if not
bundling a router.
