 Tunnel
Implementation Xaneiro de 2016 0.9.41 This page documents the current tunnel implementation.
...
| ------------- | | | |
+-----------------+-----------------+-----------------+-----------------+
| Inbound Gateway | Fragment, | Cifrar | Forward to next |
| | Batch, and Pad | | hop |
+-----------------+-----------------+-----------------+-----------------+
| Participant |   | Cifrar | Forward to next |
| | | | hop |
+-----------------+-----------------+-----------------+-----------------+
