...
- [Einführung](#intro)
- [I2P-Betrieb](#op)
 - [Übersicht](#op.overview)
 - [Tunnel](#op.tunnels)
 - [Netzwerkdatenbank](#op.netdb)
 - [Übertragungsprotokolle](#op.transport)
 - [Kryptographie](#op.crypto)
- [Zukunft](#future)
...
## Variable Latenz {#future.variablelatency}
...
*[Webseite](http://www.freenetproject.org/)*
...
## Streaming-Bibliothek {#app.streaming}
