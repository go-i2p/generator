 Tunnel Routing Juli 2011 0.8.7 
...
tunnel](images/tunnelSending.png "Alice connecting through her outbound tunnel to Bob via his inbound tunnel")
 ...
 C: Ausgehender Endpunkt
 D: Eingehende Schnittstelle
...
- [Tunnelspezifikation]()
- [Tunnelerzeugungsspezifikation]()
- [Unidirektionale
 Tunnel]()
- [Tunnelnachrichtspezifikation]()
- [Garlic-Routing]()
