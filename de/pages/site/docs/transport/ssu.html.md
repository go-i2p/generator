...
SSU\'s need for only semireliable delivery, TCP-friendly operation, and
...
## [Direkter Verbindungsaufbau]{#direct}
...
Alice verbindet sich direkt mit Bob. IPv6 wird ab Version 0.9.8
unterstützt.
...
Alice first connects to introducer Bob, who relays the request to
Charlie.
...
## [Übertragungsfenster, ACKs und erneutes Übertragen]{#acks}
