...
- Einfache Verteilgung von Anwendungen
...
- Sprach- und Themepakete für die Konsole
- Bring detailed application information to the router console
- Nicht-Java Anwendungen auch unterstützt
...
- Autostart deaktivieren funktioniert nicht immer.
