...
`SCHLÜSSEL` = Schlüsselpaar öffentlich+privat, diese sind BASE64

`SCHLÜSSEL` = öffentlicher Schlüssel, auch BASE64
...
Versionshistorie
 ...
 Version I2P Router Version Änderungen
 --------------------- -------------------- ----------------------
...
ASCII test puke forth.
 ...
 BEISPIELSITZUNGSDIALOG \-- einfaches
telnet 127.0.0.1 2827 funktioniert A = Application C = BOB\'s Command
response. FROM TO DIALOGUE C A BOB 00.00.10 C A OK A C setnick mouth C A
