...
+-----------------+-----------------+-----------------+-----------------+
| Rôle | Preprocessing | Encryption | Postprocessing |
| | | Operation | |
+=================+=================+=================+=================+
...
| | | operation) | |
+-----------------+-----------------+-----------------+-----------------+
| Point terminal |   | Decrypt (using | Reassemble |
| sortant | | an encryption | Fragments, |
...
| ------------- | | | |
+-----------------+-----------------+-----------------+-----------------+
| Passerelle | Fragment, | Chiffrer | Forward to next |
| entrante | Batch, and Pad | | hop |
+-----------------+-----------------+-----------------+-----------------+
| Participant |   | Chiffrer | Forward to next |
| | | | hop |
+-----------------+-----------------+-----------------+-----------------+
