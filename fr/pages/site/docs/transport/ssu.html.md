...
- Traversée coopérative d'une traduction d'adresses réseau ou d'un
 pare-feu en utilisant des [proposeurs](#introduction)
...
### [L'établissement d'une connexion (indirecte en utilisant un proposeur)]{#establishIndirect}
