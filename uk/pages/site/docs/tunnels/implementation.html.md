 Tunnel
Implementation Липень 2019 0.9.41 This page documents the current tunnel implementation.
...
+-----------------+-----------------+-----------------+-----------------+
| Роль | Preprocessing | Encryption | Postprocessing |
| | | Operation | |
+=================+=================+=================+=================+
...
| ------------- | | | |
+-----------------+-----------------+-----------------+-----------------+
| Inbound Gateway | Fragment, | Зашифрувати | Forward to next |
| | Batch, and Pad | | hop |
+-----------------+-----------------+-----------------+-----------------+
| Participant |   | Зашифрувати | Forward to next |
| | | | hop |
+-----------------+-----------------+-----------------+-----------------+
