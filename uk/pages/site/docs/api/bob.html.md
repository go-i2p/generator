...
Історія версії
 ...
 Версія Версія роутера I2P Зміни
 --------------------- -------------------- ------------------
 00.00.10 0.9.8 теперішня версія
 00.00.00 - 00.00.0F   версії розробки
...
Добре, там вони є. Спочатку знімемо «рот».
