...
Для добрий приклад використання дивіться у коді i2psnark.
...
active socket manager or session. See the javadocs for details.
 ...
 i2p.streaming.maxConnsPerHour 0 (на пір; 0 означає вимкнено) As of release .
 i2p.streaming.maxConnsPerDay 0 (на пір; 0 означає вимкнено) As of release .
