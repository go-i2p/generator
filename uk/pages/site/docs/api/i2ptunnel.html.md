...
### Серверні тунелі {#default-server-tunnels}
...
### Клієнтські тунелі {#default-client-tunnels}
...
### Стандартний {#client-modes-standard}
...
- *Вихідні проксі:* **User-Agent:** Uses the user agent from a recent
 Firefox release on Windows
- *Внутрішнє використання I2P:* **User-Agent:** MYOB/6.66 (AN/ON)
...
### Стандартний {#server-mode-standard}
