...
I2PControl за замовчуванням слухає на https://localhost:7650
...
#### Імплементовані методи

- - API -- \[long\] Версія API I2PControl, що клієнт вживає.
...
- - \*\*i2pcontrol.address -- \[null\] Повертається, якщо адресу
 було змінено
 - \*\*i2pcontrol.password -- \[null\] Повернуто, якщо параметр
 змінено
 - \*\*i2pcontrol.port -- \[null\] Повернуто, якщо параметр змінено
...
- - \*\*i2p.router.status -- \[String\] Що статус роутера є. A
 ...
 string and long.
 - \*\*i2p.router.version -- \[String\] Яку версію I2P працює
 роутер.
...
- -32601 -- Метод не знайдений.
- -32602 -- Неправильні параметри.
- -32603 -- Внутрішня помилка.

```{=html}
<!-- -->
```
- -32001 -- Неправильний пароль введено.
