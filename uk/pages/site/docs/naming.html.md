...
## Називання системних компонентів {#components}
...
- Must contain only \[a-z\] \[0-9\] \'.\' and \'-\' after conversion
 to lower case.
- Неможно початися з \".\" або \'-\'.
- Має закінчуватися з \'. I2p \'.
- 67 characters maximum, including the \'.i2p\'.
- Не можна містити \'.. \'.
- Не можна містити \".-\" або \"-.\" (станом на 0.6.1.33).
...
## Хост Додавання Сервіси {#add-services}
