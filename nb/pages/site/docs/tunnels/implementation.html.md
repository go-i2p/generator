 Tunnel
Implementation Juli 2019 0.9.41 This
...
+-----------------+-----------------+-----------------+-----------------+
| Rolle | Preprocessing | Encryption | Postprocessing |
| | | Operation | |
+=================+=================+=================+=================+
...
| | | operations) | |
+-----------------+-----------------+-----------------+-----------------+
| Deltager |   | Decrypt (using | Forward to next |
| | | an encryption | hop |
| | | operation) | |
+-----------------+-----------------+-----------------+-----------------+
| Utgående |   | Decrypt (using | Reassemble |
| endepunkt | | an encryption | Fragments, |
...
| ------------- | | | |
+-----------------+-----------------+-----------------+-----------------+
| Inngående | Fragment, | Krypter | Forward to next |
| portner | Batch, and Pad | | hop |
+-----------------+-----------------+-----------------+-----------------+
| Deltager |   | Krypter | Forward to next |
| | | | hop |
+-----------------+-----------------+-----------------+-----------------+
