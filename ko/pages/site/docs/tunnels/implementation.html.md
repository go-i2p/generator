...
+-----------------+-----------------+-----------------+-----------------+
| 역할 | Preprocessing | Encryption | Postprocessing |
| | | Operation | |
+=================+=================+=================+=================+
...
| | | operations) | |
+-----------------+-----------------+-----------------+-----------------+
| 참가자 |   | Decrypt (using | Forward to next |
| | | an encryption | hop |
| | | operation) | |
+-----------------+-----------------+-----------------+-----------------+
| 송신 엔드포인트 |   | Decrypt (using | Reassemble |
...
| ------------- | | | |
+-----------------+-----------------+-----------------+-----------------+
| 수신 게이트웨이 | Fragment, | 암호화 | Forward to next |
| | Batch, and Pad | | hop |
+-----------------+-----------------+-----------------+-----------------+
| 참가자 |   | 암호화 | Forward to next |
| | | | hop |
+-----------------+-----------------+-----------------+-----------------+
