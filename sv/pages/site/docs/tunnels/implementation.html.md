...
+-----------------+-----------------+-----------------+-----------------+
| Roll | Preprocessing | Encryption | Postprocessing |
| | | Operation | |
+=================+=================+=================+=================+
...
| | | operations) | |
+-----------------+-----------------+-----------------+-----------------+
| Deltagare |   | Decrypt (using | Forward to next |
| | | an encryption | hop |
| | | operation) | |
+-----------------+-----------------+-----------------+-----------------+
| Utåtgående |   | Decrypt (using | Reassemble |
| ändpunkt | | an encryption | Fragments, |
...
| ------------- | | | |
+-----------------+-----------------+-----------------+-----------------+
| Inåtgående | Fragment, | Kryptera | Forward to next |
| gateway | Batch, and Pad | | hop |
+-----------------+-----------------+-----------------+-----------------+
| Deltagare |   | Kryptera | Forward to next |
| | | | hop |
+-----------------+-----------------+-----------------+-----------------+
