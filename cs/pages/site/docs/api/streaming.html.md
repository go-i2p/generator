...
Streamovací knihovna podporuje \"TCP\" Control Block sharing. Toto sdílí
tři důležité parametry streamovací knihovny (velikost okna, dobu cesty
tam a zpět, rozptyl doby cesty tam a zpět) napříč připojeními ke
stejnému vzdálenému peerovi. Toto je použito pro \"temporal\" sdílení v
čase otevření/zavření spojení, ne k \"ensemble\" sdílení během spojení
(viz. [RFC 2140](http://www.ietf.org/rfc/rfc2140.txt)). Je zde oddělené
sdílení v závislosti na správci spojení ConnectionManager (např. pokud
jde o místní cíl) takže zde není žádný únik informací k jiným cílům na
stejném routeru. Datům sdílení pro daného peera vyprší platnost po
několika minutách. Následující parametry Control Block Sharing mohou být
nastaveny pro každý router:
