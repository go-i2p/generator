...
### Tunely serveru {#default-server-tunnels}
...
### Tunely klienta {#default-client-tunnels}
...
### Standarní {#client-modes-standard}
...
### Standarní {#server-mode-standard}
