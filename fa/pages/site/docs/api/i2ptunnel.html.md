...
### تونل های سرور {#default-server-tunnels}
...
### تونل های کاربر {#default-client-tunnels}
...
### استاندارد {#client-modes-standard}
...
### استاندارد {#server-mode-standard}
