...
+-----------------+-----------------+-----------------+-----------------+
| نقش | پیش پردازش | Encryption | Postprocessing |
| | | Operation | |
+=================+=================+=================+=================+
...
| | | operations) | |
+-----------------+-----------------+-----------------+-----------------+
| شرکت‌کننده |   | Decrypt (using | Forward to next |
| | | an encryption | hop |
| | | operation) | |
+-----------------+-----------------+-----------------+-----------------+
...
| ------------- | | | |
+-----------------+-----------------+-----------------+-----------------+
| Inbound Gateway | Fragment, | رمزگذاری | Forward to next |
| | Batch, and Pad | | hop |
+-----------------+-----------------+-----------------+-----------------+
| شرکت‌کننده |   | رمزگذاری | Forward to next |
| | | | hop |
+-----------------+-----------------+-----------------+-----------------+
